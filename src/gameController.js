    ...
    return (
        <>
            <Box display={'flex'} flexDirection={'column'} justifyContent={'center'} alignItems={'center'}>
                ...
                <Text fontSize={'xl'}>join the numbers and get to 2048 tile</Text>
                <Text fontSize={'3xl'} color={'red'}>{GameOVer}</Text>
            <Box bgColor={'#bbada0'} width={['sm','md','lg','2xl']} mt={'50'} className="game-board">
                {board.map((row, i) => {
                    return (
                ...
                <Button onClick={reset} bgColor={'#bbada0'} mt={'4'}>New game</Button>
            </Box>
        </>
    );
};
